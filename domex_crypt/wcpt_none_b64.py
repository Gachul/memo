...
def encrypt(key, iv, salt, infile, outfile):
    ...
    salting_cipher = cipher_text
    print(salting_cipher)
    
    print(hexing(salting_cipher))
    
    result_text = salting_cipher.decode()
...
def in_datas():
    ...
    if(args.encryption == 'encrypt'):
        ...
        key = b'5E6056497269736F325B59367833614D'
        iv = b'4487658493D506E5'
